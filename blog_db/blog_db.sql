...
(5,'Antipasti'),
(1,'Dolci'),
(9,'Dolci al cioccolato'),
(7,'Dolci veloci'),
(6,'Primi piatti'),
(4,'Ricette al forno'),
(3,'Ricette vegetariane'),
(8,'Ricette veloci'),
(2,'Torte');
